...
public abstract class JMXCall<T> {
    ...
    private final String jmxProcess;

    public JMXCall(final ProxyClient proxyClient, int jmxPort, String jmxProcess) {
    ...
    /**
     * @return the jmxProcess
     */
    public String getJmxProcess() {
        return jmxProcess;
    }

    public String genTag() {
        return "jmxport=" + getJmxPort() + ",jmxProc=" + getJmxProcess();
    }
